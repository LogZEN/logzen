...
(function() {
  ...
  define(['jquery', 'knockout', 'pager', 'vars', 'bootstrap', 'prettyjson'], function($, ko, pager, vars) {
    var DetailEventModel, EventListModel, EventModel, pivot;
    ...
    DetailEventModel = (function(_super) {
      __extends(DetailEventModel, _super);

      function DetailEventModel(data) {
        DetailEventModel.__super__.constructor.call(this, data);
        this.whatever = 0;
      }
    ...
    EventListModel = (function() {
      function EventListModel() {
        ...
        this.filledFilters = ko.computed((function(_this) {
          return function() {
          ...
          read: (function(_this) {
            return function() {
              ...
              if (_this.filterMode() === 'fields') {
                ...
                f = '{ "query": { "filtered": { "query": { "match_all" : {} }' + f + '} }, "from": ' + _this.page() * 50 + ', "size":  50 , "sort": [{ "time": { "order": "desc" } }] }';
      ...
      EventListModel.prototype.addTooltips = function() {
        return $('.tooltip_ip').each((function(_this) {
            ...
            return el.bind('mouseenter', function() {
              return $.ajax({
                ...
                success: function(result) {
                  var html;
                  html = '<table> <tr><td>IP Address</td><td>' + result.ip + '</td></tr> <tr><td>DNS Name</td><td> ' + result.dns + '</td></tr>';
                  if (result.aliaslist !== "") {
                  ...
                  html += '<tr><td>Country</td><td>' + result.country + ' <img src="/img/flags/' + result.flagimg + '.gif" title="' + result.country + '" alt="' + result.country + '"/></td></tr> </table>';
